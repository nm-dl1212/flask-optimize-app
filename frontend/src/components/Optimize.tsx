...
const Optimize: React.FC = () => {
  ...
  return (
    <div>
      <h2>Optimization</h2>
      <input type="number" placeholder="Initial x1" onChange={(e) => setInitialX1(Number(e.target.value))} />
      <input type="number" placeholder="Initial x2" onChange={(e) => setInitialX2(Number(e.target.value))} />
      <input type="number" placeholder="Number of Trials" onChange={(e) => setNTrials(Number(e.target.value))} />
